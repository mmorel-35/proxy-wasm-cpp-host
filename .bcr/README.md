...
This directory contains templates used by the [Publish to BCR](https://github.com/bazel-contrib/publish-to-bcr) GitHub Action to automatically publish new versions of proxy-wasm-cpp-host to the [Bazel Central Registry (BCR)](https://github.com/bazelbuild/bazel-central-registry).
...
- `{REPO}`: Repository name (proxy-wasm-cpp-host)
