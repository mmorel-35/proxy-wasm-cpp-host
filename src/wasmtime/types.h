...
using WasmSharedModulePtr = common::CSmartPtr<wasmtime_wasm_shared_module_t, wasmtime_wasm_shared_module_delete>;
...
using WasmByteVec =
    common::CSmartType<wasmtime_wasm_byte_vec_t, wasmtime_wasm_byte_vec_new_empty, wasmtime_wasm_byte_vec_delete>;
using WasmImporttypeVec = common::CSmartType<wasmtime_wasm_importtype_vec_t, wasmtime_wasm_importtype_vec_new_empty,
                                             wasmtime_wasm_importtype_vec_delete>;
using WasmExportTypeVec = common::CSmartType<wasmtime_wasm_exporttype_vec_t, wasmtime_wasm_exporttype_vec_new_empty,
                                             wasmtime_wasm_exporttype_vec_delete>;
using WasmExternVec =
    common::CSmartType<wasmtime_wasm_extern_vec_t, wasmtime_wasm_extern_vec_new_empty, wasmtime_wasm_extern_vec_delete>;
using WasmValtypeVec =
    common::CSmartType<wasmtime_wasm_valtype_vec_t, wasmtime_wasm_valtype_vec_new_empty, wasmtime_wasm_valtype_vec_delete>;
