...
# This genrule creates individual CMake config files that rules_foreign_cc can copy directly
genrule(
    name = "generate_llvm_cmake_config",
    outs = [
        "llvm_cmake_config/LLVMConfig.cmake",
        "llvm_cmake_config/LLVMConfigVersion.cmake",
        "llvm_cmake_config/LLVMExports.cmake",
    ],
    cmd = """
        # Create directory structure for output files
        mkdir -p $$(dirname $(location llvm_cmake_config/LLVMConfig.cmake))
        ...
        cat > $(location llvm_cmake_config/LLVMConfig.cmake) << EOF
...
EOF
        ...
        cat > $(location llvm_cmake_config/LLVMConfigVersion.cmake) << 'EOF'
...
EOF
        ...
        cat > $(location llvm_cmake_config/LLVMExports.cmake) << 'EOF'
