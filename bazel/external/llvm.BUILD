...
# This genrule creates a minimal LLVMConfig.cmake that provides the necessary variables
genrule(
    name = "generate_llvm_cmake_config",
    outs = [
        "llvm_cmake/lib/cmake/llvm/LLVMConfig.cmake",
        "llvm_cmake/lib/cmake/llvm/LLVMConfigVersion.cmake",
        "llvm_cmake/lib/cmake/llvm/LLVMExports.cmake",
    ],
    cmd = """
        # Create directory structure
        mkdir -p $$(dirname $(location llvm_cmake/lib/cmake/llvm/LLVMConfig.cmake))
        ...
        cat > $(location llvm_cmake/lib/cmake/llvm/LLVMConfig.cmake) << EOF
...
EOF
        ...
        cat > $(location llvm_cmake/lib/cmake/llvm/LLVMConfigVersion.cmake) << 'EOF'
...
EOF
        ...
        cat > $(location llvm_cmake/lib/cmake/llvm/LLVMExports.cmake) << 'EOF'
